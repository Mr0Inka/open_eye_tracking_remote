...
divider = 1    #Divide full image by X for faster face detection

thresh_r = 100    #Default threshold for detecting the darkest spot on the right eye
thresh_l = 100    #Default threshold for detecting the darkest spot on the right eye
lowLimit = 0.3    #Lower boundary for triggering
highLimit = 0.7    #Higher boundary for triggering
...
threshHigh = 20    #Automatically correct threshold towards this value
...
triggerLim = 10;    #Trigger after X frames over or under the high- and lowLimit
...
def correct(eye, value):    #Auto correct towards the threshHigh value
    global thresh_r
    global thresh_l
